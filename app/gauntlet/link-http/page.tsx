...
export const metadata = {
  title: 'Double Slash - Parcours d\'obstacles Noyaru',
  description: 'Page de test spécifique pour le parcours d\'obstacles Noyaru, mettant en avant un point précis à corriger.',
  alternates: {
