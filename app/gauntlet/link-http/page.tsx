...
export const metadata = {
  title: 'Liens HTTP dans le parcours d\'obstacles Noyaru',
  description: 'Découvrez le parcours d\'obstacles Noyaru et ses spécificités, notamment le cas de l\'utilisation de liens HTTP.',
  alternates: {
