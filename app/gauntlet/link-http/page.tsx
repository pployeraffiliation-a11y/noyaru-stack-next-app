...
export const metadata = {
  title: 'Page de test du parcours d\'obstacles Noyaru - Corrigé',
  description: 'Page du parcours d\'obstacles Noyaru : cette page présente un point spécifique à corriger pour le bon fonctionnement du parcours.',
  alternates: {
