...
export const metadata = {
  ...
  description: 'Deux pages qui portent exactement la meme meta description, afin de declencher la famille des doublons.\'obstacles : cette page sert à tester les anomalies SEO.',
  alternates: {
