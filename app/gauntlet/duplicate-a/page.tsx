...
export const metadata = {
  title: 'Parcours d\'obstacles : duplicate a - Test de doublon',
  description: 'Cette page illustre un cas de doublon dans le parcours d\'obstacles, avec des spécificités uniques à découvrir.',
  alternates: {
