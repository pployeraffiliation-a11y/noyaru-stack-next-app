...
export const metadata = {
  title: 'Parcours d\'obstacles : page duplicate a',
  description: 'Découvrez le parcours d\'obstacles avec une page unique pour comprendre cette anomalie de duplication.',
  alternates: {
