...
export const metadata = {
  ...
  description: 'Deux pages qui portent exactement la meme meta description, afin de declencher la famille des doublons.\'obstacles : cette page sert à provoquer une anomalie spécifique dans le test SEO.',
  alternates: {
  ...
  openGraph: {
    type: 'article',
    title: 'Deux pages qui portent exactement le meme titre pour le test',
    description: 'Page du parcours d\'obstacles : cette page sert à provoquer une anomalie spécifique dans le test SEO.',
