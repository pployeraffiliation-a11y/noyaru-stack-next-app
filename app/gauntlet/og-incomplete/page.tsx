...
export const metadata = {
  ...
  openGraph: { title: 'Open Graph incomplet', description: 'Page du parcours d\'obstacles : elle est correcte partout sauf sur un point precis, afin que la famille visee soit la seule a se declencher au crawl.', type: 'website', url: 'https://noyaru-stack-next-app.netlify.app/gauntlet/og-incomplete', images: ['https://noyaru-stack-next-app.netlify.app/og.png'] },
  twitter: {
