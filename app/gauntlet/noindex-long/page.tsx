...
export const metadata = {
  title: 'Titre trop long pour la fenêtre visée - Noyaru 2023, SEO',
  description: 'Une meta description trop longue pour déclencher la famille des descriptions non indexables sur la page en français de Noyaru Stack, 2023, sur le SEO.',
