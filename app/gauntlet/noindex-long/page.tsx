...
export const metadata = {
  ...
  description: 'Une meta description volontairement longue pour dépasser le plafond de 160 caractères, afin de déclencher les descriptions trop longues sur une page.',
