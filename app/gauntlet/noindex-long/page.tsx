...
export const metadata = {
  title: 'Titre trop long pour la fenêtre, Noyaru, 2023, correction',
  description: 'Une meta description trop longue pour dépasser le plafond de 160 caractères, afin de déclencher les descriptions trop longues sur une page non indexable.',
