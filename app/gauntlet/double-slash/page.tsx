...
export const metadata = {
  title: 'Test de la double barre dans l\'URL - Noyaru',
  description: 'Page du parcours d\'obstacles avec une double barre dans l\'URL, spécifique pour le test de la famille visée.',
  alternates: {
