...
export const metadata = {
  title: 'Hreflang non canonique - Parcours d\'obstacles Noyaru',
  description: 'Cette page illustre un cas de hreflang non canonique, où le hreflang pointe vers une page avec un canonical différent.',
  alternates: {
