...
export const metadata = {
  ...
  description: 'Cette page du parcours d\'obstacles traite d\'un cas spécifique d\'hreflang non canonique, afin d\'illustrer un point précis pour la famille ciblée.',
  alternates: {
