...
export const metadata = {
  ...
  description: 'Page du parcours d\'obstacles : elle est correcte partout sauf sur un point precis, afin que la famille visee soit la seule a se declencher au crawl.\'obstacles Noyaru, une expérience unique qui met en avant un point précis pour un meilleur crawl.',
  alternates: {
  ...
  openGraph: {
    type: 'article',
    title: 'Page de test du parcours d\'obstacles Noyaru',
    description: 'Découvrez le parcours d\'obstacles Noyaru, une expérience unique qui met en avant un point précis pour un meilleur crawl.',
