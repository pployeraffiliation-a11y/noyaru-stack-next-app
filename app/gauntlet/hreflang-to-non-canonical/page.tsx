...
export const metadata = {
  title: 'Page de test du parcours d\'obstacles Noyaru - Unique',
  description: 'Page de test du parcours d\'obstacles Noyaru, mettant en avant un point spécifique pour le crawl.',
  alternates: {
