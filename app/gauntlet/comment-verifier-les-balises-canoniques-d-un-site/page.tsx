...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://noyaru-stack-next-app.netlify.app/comment-verifier-les-balises-canoniques-d-un-site',
  },
  openGraph: {
    type: 'article',
    title: 'Comment vérifier les balises canoniques d\'un site',
...
export default function Page() {
  return (
    <main>
      ...
      <p>Pour vérifier les balises canoniques, vous pouvez utiliser des outils comme Google Search Console ou des extensions de navigateur qui analysent le code source de la page. Assurez-vous que chaque page de votre site a une balise canonique correcte pointant vers l\'URL souhaitée.</p>
