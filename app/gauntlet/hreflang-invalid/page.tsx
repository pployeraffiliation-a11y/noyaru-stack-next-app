...
export const metadata = {
  ...
  description: 'Page du parcours d\'obstacles Noyaru : cette page traite d\'un aspect spécifique du parcours.',
  alternates: {
    ...
    'x-default': 'https://noyaru-stack-next-app.netlify.app/gauntlet/hreflang-invalid',
  },
  openGraph: {
    type: 'article',
    title: 'Page de test du parcours d\'obstacles Noyaru - Hreflang Invalid',
