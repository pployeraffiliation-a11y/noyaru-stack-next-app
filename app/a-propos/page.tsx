export const metadata = {
  ...
  alternates: {
    canonical: "https://noyaru-stack-next-app.netlify.app/a-propos",
    languages: {
  ...
  openGraph: {
    ...
    images: [{ src: "https://noyaru-stack-next-app.netlify.app/og.png", alt: "Image de prévisualisation du site" }],
  },
};
